...
#ifndef SERIALIZE
	#define SERIALIZE(var) SerializedData SERIALIZED__##var##__ = SerializedData(&var, #var, typeid(var).name(), this)
	#define SERIALIZE_TYPENAME(var, name) SerializedData SERIALIZED__##var##__ = SerializedData(&var, #var, name, this)
	#define SERIALIZE_NOCLASS(var) SerializedData SERIALIZED__##var##__ = SerializedData(&var, #var, typeid(var).name())
	#define SERIALIZE_TYPENAME_NOCLASS(var, name) SerializedData SERIALIZED__##var##__ = SerializedData(&var, #var, name)
#endif